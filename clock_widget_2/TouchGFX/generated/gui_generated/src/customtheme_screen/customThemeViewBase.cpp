    ...
    buttonCallback(this, &customThemeViewBase::buttonCallbackHandler)
{
    ...
    textDegree.setTypedText(touchgfx::TypedText(T___SINGLEUSE_PGHS));
    ...
    textWhether.setTypedText(touchgfx::TypedText(T___SINGLEUSE_ODYK));
    ...
    textHour.setTypedText(touchgfx::TypedText(T___SINGLEUSE_DC0X));
    ...
    textHourCaption.setTypedText(touchgfx::TypedText(T___SINGLEUSE_NACA));
    ...
    textMinuteCaption.setTypedText(touchgfx::TypedText(T___SINGLEUSE_OFEW));
    ...
    textMinute.setTypedText(touchgfx::TypedText(T___SINGLEUSE_M5S3));
    ...
    buttonStart.setLabelText(touchgfx::TypedText(T___SINGLEUSE_5Q6Y));
    ...
    buttonStop.setLabelText(touchgfx::TypedText(T___SINGLEUSE_CH1L));
    ...
    textScheduleTime.setTypedText(touchgfx::TypedText(T___SINGLEUSE_5HYN));
    ...
    textSchedule.setTypedText(touchgfx::TypedText(T___SINGLEUSE_GGVL));
    ...
    busTime1.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    busTime1.setLinespacing(0);
    busTime1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_RAV5));
    BusPage5.add(busTime1);

    busTime2.setXY(214, 64);
    busTime2.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    busTime2.setLinespacing(0);
    busTime2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_8G7L));
    ...
    textStock.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    textStock.setLinespacing(0);
    textStock.setTypedText(touchgfx::TypedText(T___SINGLEUSE_L5RK));
    StockPage6.add(textStock);

    textStockValue.setXY(20, 96);
    textStockValue.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    textStockValue.setLinespacing(0);
    textStockValue.setTypedText(touchgfx::TypedText(T___SINGLEUSE_O6L1));
    ...
    textBattery.setTypedText(touchgfx::TypedText(T___SINGLEUSE_B95S));
    add(textBattery);
