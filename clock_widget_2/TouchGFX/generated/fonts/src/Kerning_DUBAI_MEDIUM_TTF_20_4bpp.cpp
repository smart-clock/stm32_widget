...
KEEP extern const touchgfx::KerningNode kerning_DUBAI_MEDIUM_TTF_20_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x002C, -2 },  // (First char = [0x002C, comma], Second char = [0x002A, asterisk], Kerning dist = -2)
    { 0x002E, -2 },  // (First char = [0x002E, period], Second char = [0x002A, asterisk], Kerning dist = -2)
